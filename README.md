...
![Update Pull Request](https://github.com/gynzy/pr-update-action/workflows/Update%20Pull%20Request/badge.svg)
[![Release](https://img.shields.io/github/release/gynzy/pr-update-action.svg)](https://github.com/gynzy/pr-update-action/releases/latest)
...
jobs:
  update_pr:
    ...
    steps:
    - uses: gynzy/pr-update-action@v2
      with:
